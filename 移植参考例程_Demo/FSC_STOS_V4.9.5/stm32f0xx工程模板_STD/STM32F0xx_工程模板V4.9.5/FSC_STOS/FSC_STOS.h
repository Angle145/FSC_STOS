...
#define OS_MEMORYPOOL_SIZE       4*320    //内存池大小,单位：Byte(用户只需修改320的大小)
...
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
#define OS_CMD_ALL_ENABLE        0        //剪裁全部系统指令(0-剪裁，1-不剪裁,下同)
#define OS_CMD_NSY_ENABLE        0        //剪裁系统无关的指令
#define OS_CMD_DISP_SYS_ENABLE   0        //剪裁系统状态信息指令显示(关闭显示能节省大量内存)
#define OS_CMD_DISP_NSY_ENABLE   1        //剪裁系统状态信息以外无关的指令显示
#define OS_TIMECOUNTSYS_ENABLE   0        //剪裁系统时间统计系统(剪裁可提高时间片模式下的内核切换速度)
