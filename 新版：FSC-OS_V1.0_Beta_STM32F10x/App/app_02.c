...
os_type_app_id* os_app_create__App_02(void) //创建APP_02
{
    ...
    os_thread_new_create( app_id,   thread_01,  "thread_01",   128,     10,    3,   (void*)0  ); //创建线程1 
    os_thread_new_create( app_id,   thread_02,  "thread_02",   128,     10,    3,   (void*)0  ); //创建线程2
    os_thread_new_create( app_id,   thread_03,  "thread_03",   128,     10,    5,   (void*)0  ); //创建线程3
