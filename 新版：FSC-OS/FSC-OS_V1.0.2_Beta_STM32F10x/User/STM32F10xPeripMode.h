...
#define USE_EXTI  0     //0--不使用外部中断  1--使用
#if (USE_EXTI == 1)
...
/******************************************************串口模块*******************************************************************/  
//示例：USART1_Config(9600);//波特率：9600，常用的波特率均有效
#define USE_USART                 1     //0--不使用串口  1--使用
#if (USE_USART == 1)
#define printf_use_usartx         1     //printf  串口选择 1-usart1、1-usart2、3-usart3 
...
#if (printf_use_usartx == 1)		
		//系统指令函数//	
		//OSCmdRxByte(UsartRxdata); //使用串口1作为系统指令(放在串口1中断里就使用串口1，放在其他的就使用其他的串口)
#endif		
		// 用户添加串口1接收中断代码 
		/*************************/	
